                            ...
                            {menuItems.map((item, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`absolute h-[85%] w-[88%] overflow-hidden rounded-[0.5rem] shadow-[0_45px_100px_-30px_rgba(0,0,0,0.45)] sm:h-[80%] sm:w-[75%] md:w-[45%] ${
                            ...
                            {menuItems.map((_, index) => (
                                <span
                                    ...
                                    className={`h-2.5 rounded-full transition-all duration-300 ${
                                        currentIndex === index ? 'w-6 bg-white/95' : 'w-2.5 bg-white/55'
                                    }`}
                                />
                            ))}
                        </div>
