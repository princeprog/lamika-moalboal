        ...
        >
            ...
            <div className="relative h-1/2 w-full flex flex-col items-center justify-center p-6 text-center z-10">
                <div className="max-w-5xl">
                    <motion.h1 
                        ...
                        className={`${headlineFont.className} text-3xl md:text-[7rem] lg:text-[7vw] leading-[0.85] tracking-tighter text-white`}
                    >
                        Experience the <br /> 
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30">
                <motion.a
                    ...
                    className="relative w-22 h-22 rounded-full bg-emerald-500 text-[#022c22] flex flex-col items-center justify-center gap-1 md:gap-2 group transition-shadow shadow-[0_0_30px_rgba(16,185,129,0.2)]"
                >
                    <div className="absolute inset-0 rounded-full border-[1px] md:border-[4px] border-[#022c22]" />
